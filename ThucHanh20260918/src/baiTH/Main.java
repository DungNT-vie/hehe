...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println(
                "║  1. Thêm CD (tự mở rộng mảng khi đầy)   ║"
            );
            ...
            System.out.println(
                "║  5. Tìm theo tựa - TIỀN TỐ (bên trái)   ║"
            );

            System.out.println(
                "║  6. Tìm theo tựa - HẬU TỐ (bên phải)    ║"
            );

            System.out.println(
                "║  7. Tìm theo tựa - GẦN GIỐNG (chứa)     ║"
            );
            ...
            System.out.println(
                "║  10. Sắp xếp giảm dần theo giá thành    ║"
            );

            System.out.println(
                "║  11. Sắp xếp tăng dần theo tựa CD       ║"
            );
    ...
    static void thongKe(CDList ql) {
        ...
        System.out.printf(
            "💰 Tổng giá thành: %,.2f VND\n",
            ql.tinhTongGiaThanh()
        );

        System.out.printf(
            "📈 Giá trung bình: %,.2f VND\n",
            ql.tinhGiaTrungBinh()
        );
